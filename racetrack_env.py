...
#     * Github repository: Farama-Foundation HighwayEnv                                                                                                #
#     I don't own the file. All rights reserved to the original author                   
#     for more details please check https://github.com/Farama-Foundation/HighwayEnv/tree/master
#                                                                                         #
#                                                                                         #
###########################################################################################
...
class RaceTrackEnv(AbstractEnv):
    ...
    def __init__(self, spawn_vehicles=3, random_lane=False, all_random=False, offroad_thres=-1, num_actions=1, obs_dim=(2,18,18), config: dict = None) -> None:
        ...
        config = {
            ...
            "observation": {
                ...
                "observation_shape": tuple(obs_dim[-2:]),
                "stack_size": obs_dim[0],
            ...
            "action": {
                ...
                "longitudinal": False if num_actions < 2 else True,
                "lateral": True,
                "dynamical": False,
        ...
        self.offroad_threshold = offroad_thres
